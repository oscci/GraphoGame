...
library(randomizr)
library(estimatr)
#library(rdddr)  #not available for this version of R
...
designs <- redesign(Ahmed_design,r_L.u2=c(0,.2,.4))
...
tabxx <- t(tabAhmed)
ntab<-ntab+1
tabname<-paste0("Table ",ntab,": Diagnostic results from Ahmed model with correlations between L and u_t2")
