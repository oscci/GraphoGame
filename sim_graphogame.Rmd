...
filename<-'Total_EEF_data_v096playfileFromMoodleUSETHISONE.sav'
...
plot(mydf$pre_ngrt_total_raw_score_no_outliers,mydf$post_ngrt_total_raw_score)
#scores of 1 or 2! not what we wnat
...
TOWREphon <- lm_robust(Y_t2 ~ Z + Y_t1)
summary(TOWREphon)
EffSize <- TOWREphon$coefficients[2]/sd(Y_t2,na.rm=T)
